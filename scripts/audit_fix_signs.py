...
OFFICIAL: dict[str, tuple[str, str, str]] = {
    ...
    "C18": ("indication", "Priorité par rapport au sens inverse", "C18 : dans le rétrécissement, vous passez avant le sens opposé. L'inverse (céder) est le AB5."),
    ...
    "C26a": ("indication", "Voie de détresse", "C26a : voie d'arrêt d'urgence en descente pour un véhicule en perte de freins."),
